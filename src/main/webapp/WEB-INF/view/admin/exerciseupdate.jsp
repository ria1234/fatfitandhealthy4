  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Manage Exercise Items</li>
        <li class="active">Update Exercise Item</li>
      </ol>
    </section>
				...
				<div class="col-md-8 col-md-offset-2">
							...
							<div class="box box-primary">
					            <div class="box-header with-border">
					              <h3 class="box-title">Update Exercise Item</h3>
				            </div>
							<form:form method="post" action="${pageContext.request.contextPath }/admin/updateexerciseitem" modelAttribute="Exercise">
								<form:hidden path="id"/>
				              <div class="box-body">
				                ...
				                <div class="form-group">
				                  <label>MET</label>
				                  <form:input type="number" class="form-control" path="met" required="true" step="0.01"/>
				                </div>
