...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="${pageContext.request.contextPath }" class="logo">
      ...
      <span class="logo-lg"><b>Fatfitandhealthy</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="${pageContext.request.contextPath }/admin/adminprofile" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="${pageContext.request.contextPath }/admin/signout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
...
<!--         <li><a href="documentation/index.html"><i class="fa fa-book"></i> <span>Documentation</span></a></li> -->
        ...
        <div class="col-xs-6">
          ...
          <div class="small-box bg-orange">
            <div class="inner">
              ...
              <p>New Comments<br>(In Last Week)</p>
            </div>
            <div class="icon">
        ...
        <div class="col-xs-6">
          ...
          <div class="small-box bg-teal">
            <div class="inner">
              ...
              <p>Most Eaten Food Items</p>
            </div>
            <div class="icon">
              <i class="fa fa-cutlery"></i>
            </div>
            <a href="#tenfood" class="small-box-footer" data-toggle="collapse">More info <i class="fa fa-arrow-circle-right"></i></a>
            <div class="collapse small-box-footer" id="tenfood" style="text-align: justify; padding-left: 200px;">
            	<ol>
            		<c:forEach items="${tenfood}" var="food">
            			<li>${food.key}</li>
            		</c:forEach>
      ...
      <div class="row">
          ...
          <div class="small-box bg-purple">
            <div class="inner">
              ...
              <p>Most Done Exercises</p>
            </div>
            <div class="icon">
              <i class="fa fa-heartbeat"></i>
            </div>
            <a href="#tenexercise" class="small-box-footer" data-toggle="collapse">More info <i class="fa fa-arrow-circle-right"></i></a>
            <div class="small-box-footer collapse" id="tenexercise" style="text-align: justify; padding-left: 200px;">
            	<ol>
            		<c:forEach items="${tenexercise}" var="exercise">
            			<li>${exercise.key}</li>
            		</c:forEach>
            	</ol>
            </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2016 <a href="${pageContext.request.contextPath }">Fatfitandhealthy</a>.</strong> All rights
    reserved.
  </footer>
