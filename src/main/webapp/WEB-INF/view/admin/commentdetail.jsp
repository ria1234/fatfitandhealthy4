...
<!--         right col -->
            ...
            <div class="box-header">
              <h3 class="box-title">Comments On This Post</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<tr id=${Comment[0] }>
					<td><img src="${pageContext.request.contextPath}/resources/image/user/${Comment[7] }" class="img-circle" alt="Cinque Terre" width="30" height="30"></td>
					<td>${Comment[5] } ${Comment[6]}</td>
					<td>${Comment[2] }</td>
					<td><a href="javascript:;" onclick="d(${Comment[0]});"><i class="fa fa-remove" aria-hidden="true"></i></a></td>
				</tr>
			</c:forEach>
          ...
          <!-- /.box -->
				<button class="btn btn-primary" type="button" onclick="location.href='${pageContext.request.contextPath }/admin/managePostsAndComments';">Back</button>		
					</div>
				</div>
...
function d(id) {
	...
	modal+="<p>Are you sure you want to delete this comment ?</p>";
