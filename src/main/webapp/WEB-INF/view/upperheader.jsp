      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${pageContext.request.contextPath }/resources/image/user/${cookie.uimage.value}"  class="user-image" alt="User Image">
              <span class="hidden-xs">${cookie.uname.value}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
