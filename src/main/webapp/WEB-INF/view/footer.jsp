<!-- Footer -->
	<footer id="footer" class="footer">
        ...
        <img src="${pageContext.request.contextPath }/resources/images/logo.png" width="75" width="75" alt="Logo" />
        <!-- <div class="site-logo fancy"> -->
				<a href="${pageContext.request.contextPath }" id="logo-text" class="scroll logo site-logo1 fancy">
				Fatfitandhealthy
				</a>
			<!-- </div> -->
		<!-- Copyright -->
	...
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/modernizr-latest.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/SmoothScroll.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/jquery.parallax-1.1.3.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/jquery.easing.1.3.js"></script>
	<script type="text/javascript" src="${pageContext.request.contextPath }/resources/js/jquery.superslides.js"></script>
