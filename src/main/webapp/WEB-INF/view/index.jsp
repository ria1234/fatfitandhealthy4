...
<body>
	...
	<section id="features" class="container waypoint">
		<div class="inner">        
			...
			<div class="boxes">
				...
				<p class="lead">Add Food,maintain calorie</p>
				<hr><br>
					<a class="about-icon">
				...
				<p class="lead">Nutrients Expert</p>
				<hr><br>
					<a class="about-icon">
				...
				<div class="col-xs-3 col-sm-6 col-md-3 about-box animated" data-animation="fadeIn" data-animation-delay="300">
				<p class="lead">Daily Water Intake</p>
				<hr><br>
					<a class="about-icon">
				...
				<div class="row">
				<div class="col-xs-3 col-sm-6 col-md-3 about-box animated" data-animation="fadeIn" data-animation-delay="300">
				<p class="lead">Add Exercise,<br>Maintain Calorie</p>
				<hr><br>
					<a class="about-icon">
	...
	<footer id="footer" class="footer">
        ...
        <img src="resources/images/logo.png" width="75" width="75" alt="Logo" />
        <!-- <div class="site-logo fancy"> -->
				<a href="#" id="logo-text" class="scroll logo site-logo1 fancy">
				Fatfitandhealthy
				</a>
			<!-- </div> -->
		<!-- Copyright -->
	...
	<script type="text/javascript" src="resources/js/modernizr-latest.js"></script>
	<script type="text/javascript" src="resources/js/SmoothScroll.js"></script>
	<script type="text/javascript" src="resources/js/jquery.parallax-1.1.3.js"></script>
	<script type="text/javascript" src="resources/js/jquery.easing.1.3.js"></script>
	<script type="text/javascript" src="resources/js/jquery.superslides.js"></script>
